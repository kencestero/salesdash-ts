    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-orange-500/30 bg-orange-500/10 p-6">
        ...
        <div className="mt-4 space-y-2 text-sm text-neutral-300">
          <p><strong>Current (DashTail):</strong> Login and go to /en/dashboard</p>
          <p><strong>New (Simple):</strong> This page (no auth required)</p>
          <p className="pt-4 text-neutral-400">Look at the sidebar on the left and the topbar at the top. This is what the ChatGPT layout looks like.</p>
        </div>
      </div>
    </div>
  );
